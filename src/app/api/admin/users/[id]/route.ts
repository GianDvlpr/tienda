...
export async function PUT(req: Request, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        const dataToUpdate: import("@prisma/client").Prisma.admin_userUpdateInput = { username, full_name, is_active, session_version: crypto.randomUUID(), updated_at: new Date() };
